...
<section class="pb-8 px-4 h-auto md:h-screen flex flex-wrap items-center md:justify-center relative" id="top">
    ...
    <div class="hidden md:block md:absolute md:pin-r md:pin-b text-center md:text-right mt-8 md:mt-0 md:p-8">
        <a href="#about" class="text-grey-dark">A little about me <i class="fa fa-chevron-down ml-2"></i></a>
    </div>
</section>
<section class="py-8 px-4 h-auto md:h-screen flex items-center md:justify-center relative bg-grey-lighter" id="about">
    <div class="max-w-md">
    <h2 class="text-2xl md:text-5xl my-0 text-grey-darker">A little about me</h2>
    ...
    <div class="hidden md:block md:absolute md:pin-r md:pin-b text-center md:text-right mt-8 md:mt-0 md:p-8">
        <a href="#blog" class="text-grey-dark">Most recent blog post <i class="fa fa-chevron-down ml-2"></i></a>
    </div>
    </div>
</section>
...
{{-- <h2>{{  }}</h2> --}}
<section class="px-4 h-auto py-8 md:h-screen flex items-center md:justify-center relative" id="blog">
    <div class="max-w-md">
        <h2 class="text-2xl md:text-5xl my-0 text-grey-darker">Latest blog post</h2>    
